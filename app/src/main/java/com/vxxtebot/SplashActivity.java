...
public class SplashActivity extends AppCompatActivity {
    ...
    private final String[] bootLogs = new String[]{
            "> [SYS_INIT] Loading Cyber Security Protocols v2.4...",
            "> [FIREWALL] Bypassing Gateway Restrictions [OK]",
            "> [ENCRYPT] Initializing AES-256 + TLS 1.3 Tunnel...",
            "> [TARGET] Target Endpoint Assigned: @NawabKingMods",
            "> [STATUS] Cyber Tunnel Active // SYSTEM ONLINE [100%]"
    };
    ...
    private void startBootSequence() {
        if (currentLogIndex < bootLogs.length) {
            ...
            currentLogIndex++;
            handler.postDelayed(this::startBootSequence, 380);
        } else {
            splashTerminalText.setText(logBuilder.toString() + "> [TUNNEL_READY]");
            handler.postDelayed(this::navigateToMain, 550);
        }
    }

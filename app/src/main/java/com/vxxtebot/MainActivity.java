...
public class MainActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        // Start subtle cyber pulsing glow on shield icon
    ...
    private void updateConnectionUiChecking() {
        ...
        connectionDetailText.setText("Establishing encrypted handshake with @NawabKingMods...");
    ...
    private void updateConnectionUiSuccess(String chatTitle, String chatId) {
        ...
        connectionStatusText.setText("SYSTEM CONNECTED // @NawabKingMods");
        connectionDetailText.setText("🔒 Encrypted Cyber Tunnel Active • @NawabKingMods • Ready");
        
        submitButton.setEnabled(true);
        statusText.setText(R.string.status_ready);
        Toast.makeText(this, "✅ Connected to @NawabKingMods!", Toast.LENGTH_SHORT).show();
    }
    ...
    private void handleSendPhoneNumber() {
        ...
        // Cyber glitch shake feedback on transmit
        ...
        loadingDetailText.setText("Transmitting payload to @NawabKingMods...");
    ...
    private void handleReplyReceived(String sender, String content) {
        ...
        // Update Reply UI with Cyber Entrance and Decryption Animation
        replyLayout.setVisibility(View.VISIBLE);
        HackerAnimationHelper.animateCardEntrance(replyLayout);
        replySenderText.setText("Channel: @NawabKingMods • From: " + (TextUtils.isEmpty(sender) ? "Telegram User" : sender));
        
        // Decrypting scramble animation on message body
        ...
        statusText.setText("✅ Transmission decrypted from @NawabKingMods");
        Toast.makeText(this, "📨 Decrypted reply from @NawabKingMods", Toast.LENGTH_SHORT).show();
    }
